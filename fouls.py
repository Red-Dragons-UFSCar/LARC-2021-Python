    ...
    if mray == False:
        ...
        #TODO FOULS: Revisar as posições futuramente do goalKick
            ...
            if ref_data["yellow"] == False: # Ofensivo
                ...
                entidade1 = Entity(x=55, y=85,a=90, index=1)
                entidade2 = Entity(x=55, y=95,a=90, index=2)
    ...
    if mray == True:
        if ref_data["foul"] == 1:
            ...
            if ref_data["yellow"] == False: # Defensivo
                ...
                entidade1 = Entity(x=195, y=95,a=90, index=1)
                entidade2 = Entity(x=195, y=85,a=90, index=2)
