...
def replacement_fouls(replacement, ref_data, mray):
    ...
    if mray == False:
        ...
        #TODO FOULS: Revisar as posições futuramente do goalKick
            ...
            if ref_data["quad"] == 1:
                entidade0 = Entity(x=22, y=90,a=0, index=0)
                entidade1 = Entity(x=44.54, y=95.20,a=-70.01, index=1)
                entidade2 = Entity(x=40.98, y=104.99,a=-70.01, index=2)
                entidade3 = Entity(x=155, y=150,a=0, index=3)
                entidade4 = Entity(x=70, y=150,a=-25, index=4)
            elif ref_data["quad"] == 2:
                entidade0 = Entity(x=22, y=90,a=0, index=0)
                entidade1 = Entity(x=38.80, y=108.25,a=-42.51, index=1)
                entidade2 = Entity(x=31.12, y=115.29,a=-42.51, index=2)
                entidade3 = Entity(x=45, y=150,a=0, index=3)
                entidade4 = Entity(x=80, y=70,a=0, index=4)
            elif ref_data["quad"] == 3:
                entidade0 = Entity(x=22, y=90,a=0, index=0)
                entidade1 = Entity(x=31.12, y=64.70,a=-137.48, index=1)
                entidade2 = Entity(x=38.80, y=71.74,a=-137.48, index=2)
                entidade3 = Entity(x=45, y=30,a=0, index=3)
                entidade4 = Entity(x=80, y=110,a=0, index=4)
            elif ref_data["quad"] == 4:
                entidade0 = Entity(x=22, y=90,a=0, index=0)
                entidade1 = Entity(x=40.98, y=75.00,a=-109.98, index=1)
                entidade2 = Entity(x=44.54, y=84.79,a=-109.98, index=2)
            ...
            if ref_data["yellow"] == False: # Ofensivo
                ...
                entidade1 = Entity(x=44.54, y=84.79,a=90, index=1)
                entidade2 = Entity(x=44.54, y=95.20,a=90, index=2)
    ...
    if mray == True:
        if ref_data["foul"] == 1:
            ...
            if ref_data["quad"] == 1:
                ...
                entidade1 = Entity(x=218.87, y=115.29, a=222.51, index=1)
                entidade2 = Entity(x=211.19, y=108.25,a=222.51, index=2)
                entidade3 = Entity(x=205, y=150,a=0, index=3)
                entidade4 = Entity(x=170, y=70,a=0, index=4)
            elif ref_data["quad"] == 2:
                entidade0 = Entity(x=228, y=90,a=0, index=0)
                entidade1 = Entity(x=209.01, y=104.99,a=250.01, index=1)
                entidade2 = Entity(x=205.45, y=95.20,a=250.01, index=2)
                entidade3 = Entity(x=95, y=150,a=180, index=3)
                entidade4 = Entity(x=180, y=150,a=205, index=4)
            elif ref_data["quad"] == 3:
                entidade0 = Entity(x=228, y=90,a=0, index=0)
                entidade1 = Entity(x=205.45, y=84.79,a=289.98, index=1)
                entidade2 = Entity(x=209.01, y=75.00,a=289.98, index=2)
                entidade3 = Entity(x=95, y=30,a=0, index=3)
                entidade4 = Entity(x=180, y=30,a=155, index=4)
            elif ref_data["quad"] == 4:
                entidade0 = Entity(x=228, y=90,a=0, index=0)
                entidade1 = Entity(x=211.19, y=71.74,a=317.48, index=1)
                entidade2 = Entity(x=218.87, y=64.70,a=317.48, index=2)
                entidade3 = Entity(x=205, y=30,a=0, index=3)
                entidade4 = Entity(x=170, y=110,a=180, index=4)
            replacement.place_all([entidade0, entidade1, entidade2, entidade3, entidade4])
            ...
            if ref_data["yellow"] == False: # Defensivo
                ...
                entidade1 = Entity(x=205.45, y=95.20,a=90, index=1)
                entidade2 = Entity(x=205.45, y=84.79,a=90, index=2)
