    ...
    if mray == False:
        if ref_data["foul"] == 1:
            ...
            if ref_data["yellow"] == False: # Ofensivo
                entidade0 = Entity(x=115, y=70,a=45, index=0)
                entidade1 = Entity(x=46.51, y=85.5,a=90, index=1)
                entidade2 = Entity(x=46.51, y=94.5,a=90, index=2)
                entidade3 = Entity(x=115, y=110,a=-45, index=3)
                entidade4 = Entity(x=115, y=90,a=0, index=4)
            else: # Defensivo
                entidade0 = Entity(x=90, y=115,a=-30, index=0)
                entidade1 = Entity(x=46.51, y=85.5,a=90, index=1)
                entidade2 = Entity(x=46.51, y=94.5,a=90, index=2)
                entidade3 = Entity(x=90, y=65,a=30, index=3)
