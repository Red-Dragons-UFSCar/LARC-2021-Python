...
def replacement_fouls(replacement, ref_data, mray):
    ...
    if mray == False:
        if ref_data["foul"] == 1:
            ...
            if ref_data["quad"] == 1:
                entidade0 = Entity(x=22, y=90,a=0, index=0)
                entidade1 = Entity(x=70, y=95.54,a=-70.01, index=1)
                ...
                entidade0 = Entity(x=22, y=90,a=0, index=0)
                entidade1 = Entity(x=70, y=74.00,a=-109.98, index=1)
                entidade2 = Entity(x=46.51, y=84.45,a=-109.98, index=2)
            ...
            if ref_data["yellow"] == False: # Ofensivo
                ...
                entidade1 = Entity(x=46.51, y=85.5,a=90, index=1)
                entidade2 = Entity(x=46.51, y=94.5,a=90, index=2)
                entidade3 = Entity(x=95, y=90,a=0, index=3)
    ...
    if mray == True:
        if ref_data["foul"] == 1:
            ...
            if ref_data["quad"] == 1:
                ...
                entidade0 = Entity(x=228, y=90,a=0, index=0)
                entidade1 = Entity(x=180, y=105.99,a=250.01, index=1)
                ...
                entidade0 = Entity(x=228, y=90,a=0, index=0)
                entidade1 = Entity(x=180, y=84.45,a=289.98, index=1)
                entidade2 = Entity(x=207.28, y=74.00,a=289.98, index=2)
            ...
            if ref_data["yellow"] == False: # Defensivo
                ...
                entidade3 = Entity(x=155, y=90,a=180, index=3)
                entidade4 = Entity(x=160, y=115,a=215, index=4)
            else: # Ofensivo
                entidade0 = Entity(x=235, y=90,a=0, index=0)
                entidade1 = Entity(x=203.48, y=85.5,a=90, index=1)
                entidade2 = Entity(x=203.48, y=94.5,a=90, index=2)
